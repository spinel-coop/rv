...
pub(crate) fn new(_global_args: &GlobalArgs, args: NewArgs) -> Result<()> {
    let name = args.name;
    validate_name(&name)?;

    static GEMSPEC_J2: &str = include_str!("templates/gemspec.j2");
    static LIB_MAIN_J2: &str = include_str!("templates/lib_main.j2");
    static BIN_CONSOLE_J2: &str = include_str!("templates/bin_console.j2");
    static GEMFILE_J2: &str = include_str!("templates/gemfile.j2");
    static README_J2: &str = include_str!("templates/readme.j2");
    static MINITEST_TEST_HELPER_J2: &str = include_str!("templates/minitest_test_helper.j2");
    static MINITEST_TEST_J2: &str = include_str!("templates/minitest_test.j2");
    static RSPEC_SPEC_HELPER_J2: &str = include_str!("templates/rspec_spec_helper.j2");
    static RSPEC_SPEC_J2: &str = include_str!("templates/rspec_spec.j2");
